      ...
      <nav className="navbar navbar-expand-md px-3">
        ...
        <div className="collapse navbar-collapse" id={props.id}>
          <div className="navbar-nav ms-auto">
            ...
            <Link className="nav-link dropdown-toggle" data-bs-toggle='dropdown' data-bs-target='#nav-dropdown'>Gallery</Link>

            <ul className="dropdown-menu" id="nav-dropdown">
              <li><Link to='/modernArt' className="dropdown-item" >Modern Arts</Link></li>
              <li><Link to='/renaissanceArt' className="dropdown-item" >Renaissance Arts</Link></li>
            </ul>
            </div>
